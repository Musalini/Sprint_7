...
public class Mesto1Test {
    String bearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NmRjNjIwNWZlNGJmMzAwM2Q3NTU4ZTMiLCJpYXQiOjE3MzA3NTQzNzcsImV4cCI6MTczMTM1OTE3N30.B1afqXTwdANbU7AXr4S1saI_bstefdkYhbMYV1tu668";
    ...
    private void deleteLikePhotoById(String photoId) {
        ...
        given()
                ...
                .then().assertThat().statusCode(205); // Проверяем, что сервер вернул код 200
    }
}
