...
public class CourierLoginTests {
    ...
    private final Courier validCourier = new Courier("MusMur", "Password");
    ...
    public void testCourierLoginWithIncorrectPassword() {
        courierApiSteps.createCourier();
        verifyLoginResponse(new Courier("MusMur", "WrongPassword"), HttpURLConnection.HTTP_NOT_FOUND, "Учетная запись не найдена");
    }
